...
const TRANSLATIONS = {
  ...
  en: {
    ...
    admin_tab_title:       'Admin — Dropdown options',
    admin_tab_help:        'Edit menu options. One per line or comma-separated. Save each section to apply. System merit points (Weekly update, Complete profile, 50 updates) and task grade points are applied retroactively to all existing events.',
    admin_careers_majors:  'Careers / Majors',
    admin_semesters:       'Semesters',
    admin_personality_tags:'Personality tags',
    admin_personality_hint:'Dictionary: tag : displayed text. One per line. E.g. ptag_creative: Creative',
    admin_collab_suggestions: 'Collaboration suggestions',
    admin_merit_tiers:     'Merit tiers',
    admin_empty_ok:        'Empty is OK',
    admin_section_profile: 'Profile',
    admin_section_profile_hint: 'Profile form options: careers, semesters, personality tags (dict tag:display text), collaboration suggestions.',
    admin_section_merits:  'Merits & achievements',
    admin_section_merits_hint: 'Merit types, domains, tiers, and system merit points (Weekly update, Complete profile, 50 updates). Applied retroactively on save.',
    admin_section_tasks:  'Tasks',
    admin_section_tasks_hint: 'Points per grade in "Request Review" flow. Applied retroactively.',
    admin_system_merit_points: 'System merit points',
    admin_system_merit_hint: 'Weekly update, Complete profile, 50 updates. Applied retroactively on save.',
    admin_system_weekly: 'Weekly update',
    admin_system_profile: 'Complete profile',
    admin_system_milestone: '50 updates',
    admin_task_grade_points: 'Points per reviewed task',
    admin_task_grade_points_hint: 'Individual = 1 assignee. Team = 2+ assignees. Applied retroactively.',
    admin_task_grade_individual: 'Individual',
    admin_task_grade_team: 'Team (per member)',
    admin_retroactive: 'Retroactive',
    ...
    requested_category:   'Requested area',
    ...
    // ── Areas (team divisions; internal: categories) ──────────────────────────
    categories_title: 'Areas',
    add_category:     'Add Area',
    category_name:    'Area name',
    description:      'Description (optional)',
    no_categories:    'No areas yet.',
    no_members_cat:   'No members in this area.',
    cat_placeholder:  'e.g. Mechanics',
    desc_placeholder: 'Description…',
    member_s:         (n) => `${n} member${n !== 1 ? 's' : ''}`,
    no_members_yet:   'No members yet',
    add_cat_name:     'New area name',
    edit_category:    'Editing:',
    update_category:  'Update',
    no_members_here:  'No members in this area yet.',
    update_cat:       'Update',
    ...
    category:              'Area',
    global_category:       'Global (any area)',
    add_merit:             'Add Merit',
    ...
    merit_type_técnico:    'Technical',
    merit_type_liderazgo:  'Leadership',
    merit_type_colaboración:'Collaboration',
    merit_type_innovación:  'Innovation',
    merit_type_hito:       'Milestone',
    merit_type_investigación:'Research',
    merit_type_comunicación:'Communication',
    merit_type_documentación:'Documentation',
    merit_type_presentación:'Presentation',
    merit_type_otro:       'Other',
    ...
    merit_domain_mecánica:  'Mechanical',
    merit_domain_electrónica:'Electronics',
    merit_domain_diseño:   'Design',
    merit_domain_investigación:'Research',
    merit_tier_bronze:     'Bronze',
    merit_tier_silver:     'Silver',
    merit_tier_gold:       'Gold',
    merit_tier_bronce:     'Bronze',
    merit_tier_plata:      'Silver',
    merit_tier_oro:        'Gold',
    ...
    delete_matrix_confirm: 'Delete this matrix? This cannot be undone.',
    ...
    topic_label:          'Topic',
    add_topic:            'Add topic',
    topic_title_ph:       'Topic title',
    request_review:       'Request review',
    review_requested:     'Review requested',
    review_approved:      'Approved',
    academy_eval_personal:'Evaluation is personal — a mentor will review you.',
    ...
    new_swot_btn:       'New SWOT',
    swot_new_entry:     'SWOT analysis',
    swot_name_ph:       'e.g. Project X, Q1 strategy',
    ...
    tools_create_leader_only: 'Only leaders and above can create new entries.',
    ...
    category_only_hint:   'Only visible to members of this area',
    no_access_tool:       'You do not have access to this tool.',
    can_edit_scope_hint:  'Only leaders and admins of this area can edit.',

    // ── Tools — how-to descriptions ───────────────────────────────────────────
    tool_desc_calendar:
      'Track upcoming events, competitions, deadlines, and milestones. Everyone can see global events; area events are visible only to that area. Check the box to show birthdays (global or by area).',
    tool_desc_swot:
    ...
    eisenhower_new_matrix: 'New matrix',
    eisenhower_matrix_name_ph: 'Matrix name (e.g. Project X)',
    pugh_new_matrix:      'New matrix',
    pugh_matrix_name_ph:  'Matrix name (e.g. Q1 decision)',
    ...
    pugh_total:           'Total',
    pugh_weighted_total:  'Weighted total',
    pugh_issue:           'Issue',
    pugh_datum:           'Datum',
    pugh_weight:          'Weight',
    pugh_no_matrices:     'No matrices yet. Create one to get started.',
    ...
    // ── Profile — Weekly Status (present continuous) ───────────────────────────
    section_weekly:          'This Week',
    weekly_advanced:         'What I\'m advancing on…',
    weekly_failed_at:        'What I\'m struggling with…',
    weekly_learned:          'What I\'m learning…',
    weekly_ph_advanced:      'What\'s moving forward?',
    weekly_ph_failed:        'What isn\'t going as planned?',
    weekly_ph_learned:       'What are you getting better at?',
    ...
    join_pick_category:      'Pick your area',
    ...
    join_category_required:  'Please select an area.',
    which_category:          'Which area do you want to join?',
    no_categories_join:      "No areas defined yet — you'll be assigned one later.",
